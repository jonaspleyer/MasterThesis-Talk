...
\begin{frame}
	\begin{figure}
		\centering
		\scalebox{0.6}{\import{Part2-Main/Pictures/}{TOV-LE-Combi.pgf}}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\scalebox{0.6}{\import{Part2-Main/Pictures/}{LE-ValidateSols.pgf}}
	\end{figure}
\end{frame}
...
\begin{frame}
	\begin{figure}
		\centering
		\scalebox{0.6}{\import{Part2-Main/Pictures/}{TOV-Terms.pgf}}
	\end{figure}
\end{frame}
...
% 	Show all the nice plots with the $n$ vs $\xi_0$ for different parameters plotted
	\begin{figure}
		\centering
		\scalebox{0.65}{\import{Part2-Main/Pictures/}{TOV-Exponents-LESubs-InitialVals-Database-PlotResults.pgf}}
...
\begin{frame}
	\begin{figure}
		\centering
		\scalebox{0.65}{\import{Part2-Main/Pictures/}{TOV-Exponents-LESubs-InitialVals-Database-PlotResults-1.pgf}}
